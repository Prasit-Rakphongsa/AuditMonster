        ...
        <div class="content-container">
            ...
            <div class="content">
                <?php
                    ...
                    echo '<form action="EditEvent.php" method="POST" style="display:inline;"><input type="hidden" name="eventCode" value="'.$event[0]["event_code"].'"><input type="hidden" name="subEventCode" value="'.$event[0]["sub_event_code"].'">';
