        ...
        if($event[$i]["send_to_edw"] == "Y" or $event[$i]["send_to_edw"] == "y"){
            ...
            for($k=2; $k<count($field); $k++){
                if($field[$k]["field_name"] == "SUB_EVENT_CODE"){
                    ...
                    // } else 
                    if($field[$k]["send_to_edw"] == "Y" or $field[$k]["send_to_edw"] == "y"){
                        if($filtered_event_field_relation[$event[$i]["event_code"]][$event[$i]["sub_event_code"]][$field[$k]["field_name"]][1] == "Y" or $filtered_event_field_relation[$event[$i]["event_code"]][$event[$i]["sub_event_code"]][$field[$k]["field_name"]][1] == "y"){
